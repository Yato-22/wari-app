...
class ProfileOrgManagementScreen extends StatelessWidget {
  const ProfileOrgManagementScreen({super.key});
        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Container(
                                ...
                                child: Text(
                                  'Camp Organiser • Vitthal Seva Camp',
              ...
              // Organiser Management Navigation Tiles
              Container(
                decoration: BoxDecoration(
                  color: AppColors.surfaceContainerLowest,
                  borderRadius: BorderRadius.circular(16),
                ...
                child: Column(
                  children: [
                    ...
                    _buildTile(
                      ...
                      title: 'Organiser Application Status',
                      subtitle: 'Track verification & field inspection status',
                      onTap: () {
                        Navigator.of(context).pushNamed(AppRoutes.applicationStatus);
                      },
                    ),
                  ],
                ),
                ...
                child: Column(
                  children: [
                    _buildTile(
                      ...
                      title: 'Help & Support',
                      subtitle: 'Helpline & organiser assistance',
                      onTap: () {
                    ...
                    _buildTile(
                      ...
                      subtitle: 'App version & pilgrimage guidelines',
                      onTap: () {
